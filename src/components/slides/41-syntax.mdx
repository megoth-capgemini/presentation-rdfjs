...
<aside className="notes">
    In this example we can see 15 statements altogether (not to be confused with RDF statements). Note that statements
    can be concluded with a semi-colon, but I've omitted that here for readability.
