...
<aside className="notes">
    rdflib.js is probably the oldest RDF-compatible JavaScript-library that's still being maintained. It's age is
    apparent in some of its API design, but is by far the most reliable library out there. (An example old-style
    syntax is the use of callback functions on lines 9-12 and lines 21-24 instead of Promises.)
